...
namespace WindowsFormsApplication1
{
    ...
    public partial class boardForm : Form
    {
        ...
        Image bKing = Image.FromFile("C:\\Data\\CheckersOfficial\\2AA4 pics\\BlackCheckerKing.png"); //See 4.5.1b of documentation
        Image wKing = Image.FromFile("C:\\Data\\CheckersOfficial\\2AA4 pics\\WhiteCheckerKing.png"); //See 4.5.1c of documentation
        Image bPiece = Image.FromFile("C:\\Data\\CheckersOfficial\\2AA4 pics\\BlackChecker.png"); //See 4.5.1d of documentation
        Image wPiece = Image.FromFile("C:\\Data\\CheckersOfficial\\2AA4 pics\\WhiteChecker.png"); //See 4.5.1e of documentation
        Image emptySpace = Image.FromFile("C:\\Data\\CheckersOfficial\\2AA4 pics\\Koala.jpg"); //See 4.5.1f of documentation
        ...
        private void startToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.Yes)
            {
                ...
                if (ChoiceResult == DialogResult.Yes)
                {
                    ...
                    computerBox.BackgroundImage = Image.FromFile("C:\\Data\\CheckersOfficial\\2AA4 pics\\shaq.jpg");
                }
                else
                {
                    playerColour = Colour.black;
                    computerBox.BackgroundImage = Image.FromFile("C:\\Data\\CheckersOfficial\\2AA4 pics\\koalaBear.jpg");
                }
